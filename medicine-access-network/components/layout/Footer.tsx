        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-9 pb-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="text-lg leading-[1.02] tracking-[-0.035em]"
              >
                the facilitator
                <br />
              ...
              <ul className="space-y-1">
                {links.map(({ href, label }) => (
                  <li key={href}>
                    <Link
                      href={href}
                      className="inline-flex min-h-9 items-center text-sm leading-relaxed text-foreground underline-offset-4 transition-colors hover:underline"
                    >
                      {t(label)}
                    </Link>
                  </li>
