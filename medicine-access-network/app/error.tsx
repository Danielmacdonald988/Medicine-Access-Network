...
export default function GlobalError({ error, reset }: ErrorPageProps) {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center justify-center px-4 py-32 text-center">
      ...
      <h1 className="mt-4 text-xl font-semibold text-stone-900">{t('Something went wrong')}</h1>
      <p className="mt-2 text-sm text-stone-500">
        {t('An unexpected error occurred. You can try again or return to the home page.')}
      </p>
      {error.digest && (
