...
| Preferred | Avoid |
|---|---|
| Facilitator | Provider (implies medical) |
| Guide | Therapist (unless licensed) |
| Preparation coaching | Pre-ceremony dosing |
| Integration support | Post-trip therapy |
| Breathwork | Psychedelic breathwork |
| Somatic coaching | Body-based healing |
| Plant medicine-adjacent | Plant medicine ceremony |
| Support | Treatment |
| Journey | Trip |
| Non-ordinary states | Psychedelic experience |
| Harm reduction education | Drug safety |
| Legal services | Ceremony facilitation |
...
- **High-trust, grounded** — Not sensational, not clinical, not underground
- **Earnest and clear** — Seekers are often vulnerable; be honest about what we are and aren't
- **Respectful of the work** — Avoid flippancy; this is serious, meaningful work for many people
- **Safety-first** — Lead with what we do to protect users, not just what we offer
- **Non-preachy** — State the legal boundaries clearly, do not moralize

## What to Avoid in All Copy

- Claims that services "heal," "cure," "treat," or "solve" any condition
- Guarantees of outcomes
- Language implying clinical authority without credentials
- References to substance dosing, procurement, or ceremony coordination
- Implying that platform verification means clinical endorsement
